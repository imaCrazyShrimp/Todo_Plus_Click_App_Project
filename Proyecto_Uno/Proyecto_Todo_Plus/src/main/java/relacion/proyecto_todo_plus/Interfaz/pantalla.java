...
grupo.add(jToggleButton3);
grupo.add(jToggleButton4);
grupo.add(jToggleButton5);
grupo.add(jToggleButton6);
grupo.add(jToggleButton7);
grupo.add(jToggleButton8);
    }
    ...
    panelContenido.add(new PanelRegistrarProducto(), java.awt.BorderLayout.CENTER);
   ...
   panelContenido.removeAll();
    panelContenido.add(new PanelModificar(), java.awt.BorderLayout.CENTER);
    panelContenido.revalidate();
    panelContenido.repaint();        // TODO add your handling code here:
    }//GEN-LAST:event_jToggleButton2ActionPerformed

    private void jToggleButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton3ActionPerformed
      panelContenido.removeAll();
    panelContenido.add(new PanelEliminar(), java.awt.BorderLayout.CENTER);
    panelContenido.revalidate();
    panelContenido.repaint();
    ...
    private void jToggleButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton4ActionPerformed
        panelContenido.removeAll();
    panelContenido.add(new PanelVisualizar(), java.awt.BorderLayout.CENTER);
    panelContenido.revalidate();
    panelContenido.repaint(); 
    ...
    private void jToggleButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton5ActionPerformed
         panelContenido.removeAll();
    panelContenido.add(new PanelCarga(), java.awt.BorderLayout.CENTER);
    panelContenido.revalidate();
    panelContenido.repaint(); 
    ...
    private void jToggleButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton6ActionPerformed
         panelContenido.removeAll();
    panelContenido.add(new PanelGuardar(), java.awt.BorderLayout.CENTER);
    panelContenido.revalidate();
    panelContenido.repaint();
    ...
    private void jToggleButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton7ActionPerformed
     panelContenido.removeAll();
    panelContenido.add(new PanelRegistros(), java.awt.BorderLayout.CENTER);
    panelContenido.revalidate();
    panelContenido.repaint();   // TODO add your handling code here:
    ...
    private void jToggleButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton8ActionPerformed
        panelContenido.removeAll();
    panelContenido.add(new PanelBuscar(), java.awt.BorderLayout.CENTER);
    panelContenido.revalidate();
    panelContenido.repaint();
